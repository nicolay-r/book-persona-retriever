# import pandas as pd
# from parlai.core.metrics import BleuMetric, RougeMetric, F1Metric
#
# bleu_metric = BleuMetric.compute(guess="hello", answers=["hello"], k=4)
# rouge_metric = RougeMetric.compute_many(guess="hello", answers=["hell"])
# f1 = F1Metric.compute(guess="hello", answers=["hello"])
#
# print(bleu_metric)
# print(rouge_metric)
# print(f1)
...
# read the related response from the sqlite

# read the query from the csv.
import sqlite3
